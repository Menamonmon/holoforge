...
async def test_project_vertex_to_viewport(dut):
    ...
    async def test_single():
        ...
        dut.x_in.value = random.randint(0, HRES - 1)
        dut.y_in.value = random.randint(0, VRES - 1)
        dut.area_in.value = random.randint(0, HRES * VRES - 1)
...
def main():
    ...
    sources = [
        proj_path / "src" / "hdl" / "camera" / "wrapped_camera_control.sv",
    ...
    runner.build(
        sources=sources,
        hdl_toplevel="wrapped_camera_control",
        always=True,
    ...
    runner.test(
        hdl_toplevel="wrapped_camera_control",
        test_module="test_wrapped_camera_control",

...
async def test_projection(dut):
    ...
    dut.P.value=BinaryValue(vec_to_bin([normalized_fam(i) for i in test_case["P"]],WIDTH_P))
    dut.C.value=BinaryValue(vec_to_bin([c_fam(i) for i in test_case["C"]],WIDTH_C))
    dut.u.value=BinaryValue(vec_to_bin([normalized_fam(i) for i in test_case["u"]],WIDTH_V))
    dut.v.value=BinaryValue(vec_to_bin([normalized_fam(i) for i in test_case["v"]],WIDTH_V))
    dut.n.value=BinaryValue(vec_to_bin([normalized_fam(i) for i in test_case["n"]],WIDTH_V))

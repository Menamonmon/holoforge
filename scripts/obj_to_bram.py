...
def obj_to_bram(obj_folder_path, out_folder_path):
	...
	with open(f"{out_folder_path}/mesh.mem", "w") as f:
		for face in faces:
			...
			c1, c2, c3 = [vt_to_rgb(textures_points[i[1] - 1], texture) for i in face]
			f.write(triangle_line(v1, v2, v3, norm, c1, c2, c3))
...
def triangle_line(v1, v2, v3, norm, c1, c2, c3):
	...
	# 72 * 3 / 4 = 54 hexes
	return f"{v1[0]:04x}{v1[1]:04x}{v1[2]:04x}{v2[0]:04x}{v2[1]:04x}{v2[2]:04x}{v3[0]:04x}{v3[1]:04x}{v3[2]:04x}{norm[0]:04x}{norm[1]:04x}{norm[2]:04x}{c1:02x}{c2:02x}{c3:02x}\n"
